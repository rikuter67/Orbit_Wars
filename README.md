...
- [LOG.md](LOG.md)  
  最初に見る場所。採用版、最新スコア、次にすべきことがまとまっている。
- [SUBMISSION_LOG.md](SUBMISSION_LOG.md)  
  次に見る場所。なぜその提出を選んだかが時系列で分かる。

順番: `LOG.md` → `SUBMISSION_LOG.md` → `logs/snapshot...` → `logs/local_eval...`
