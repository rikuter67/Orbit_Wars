...
def plan_lite_waves(
    *,
    ...
    partial_def_bonus: float = 5.0,
    partial_attack_penalty: float = 3.0,
):
...
def run_turn(obs_tensors: dict, *, config: ProducerLiteConfig, player_count: int, memory) -> dict:
    ...
    entries = plan_lite_waves(
        ...
        partial_def_bonus=getattr(memory, "partial_def_bonus", 5.0),
        partial_attack_penalty=getattr(memory, "partial_attack_penalty", 3.0),
    )
...
class ProducerLiteMemory:
    def __init__(self) -> None:
        ...
        self.partial_def_bonus: float = 5.0
        self.partial_attack_penalty: float = 3.0
